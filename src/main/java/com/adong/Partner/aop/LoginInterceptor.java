...
public class LoginInterceptor {
    ...
    @Before("execution(* com.adong.Partner.controller.*.*(..)) && " +
            "!execution(* com.adong.Partner.controller.UserController.userLogin(..)) && " +
            "!execution(* com.adong.Partner.controller.UserController.userRegister(..))")
