package com.adong.Partner.service.ws;


import cn.hutool.core.date.DateUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.adong.Partner.config.HttpSessionConfig;
...
import com.adong.Partner.model.request.MessageRequest;
...
@Component
@Slf4j
@ServerEndpoint(value = "/websocket/{userId}", configurator = HttpSessionConfig.class)
public class WebSocket {
     ...
     * 聊天服务
     */
    private static com.hjj.homieMatching.service.ChatService chatService;
    /**
     * 团队服务
     */
     ...
     */
    @Resource
    public void setHeatMapService(com.hjj.homieMatching.service.ChatService chatService) {
